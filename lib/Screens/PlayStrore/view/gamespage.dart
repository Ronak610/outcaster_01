          ...
          children: [
            InkWell(
              ...
              child: Container(
                ...
                child: Text("Top free",style: TextStyle(color: Colors.blueAccent.shade700),),
              ),
            ),
            InkWell(
              onTap: (){
              ...
              child: Container(
                ...
                width: 24.w,
                decoration: BoxDecoration(
                  color: ProviderFalse!.c2?Colors.blueAccent:Colors.white,
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(color: Colors.black12)
                ),
                alignment: Alignment.center,
                child: Text("Top grossing",style: TextStyle(color: Colors.blueAccent.shade700),),
              ),
            ),
            InkWell(
              onTap: (){
              ...
              child: Container(
                ...
                width: 19.w,
                decoration: BoxDecoration(
                  color: ProviderFalse!.c3?Colors.blueAccent:Colors.white,
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(color: Colors.black12)
                ),
                alignment: Alignment.center,
                child: Text("Tranding",style: TextStyle(color: Colors.blueAccent.shade700),),
              ),
            ),
            InkWell(
              onTap: (){
              ...
              child: Container(
                ...
                alignment: Alignment.center,
                child: Text("Top paid",style: TextStyle(color: Colors.blueAccent.shade700),),
              ),
            ),
          ],
        ),
